void fuzzy_main_obj(){
    ...
    */
    ...
    // inisialisasi nilai member  fuzzy input TDS
    ...
    // inisialisasi nilai member fuzzy output (estimasi waktu) aktif pompa pH naik (basa)
    ...
    // inisialisasi nilai member fuzzy output (estimasi waktu) Pompa PH Turun (Asam)
    ...
    // inisialisasi nilai member fuzzy output (estimasi waktu) Pompa Air Baku
    ...
    // inisialisasi nilai member fuzzy output Pompa Nutrisi (estimasi waktu)
